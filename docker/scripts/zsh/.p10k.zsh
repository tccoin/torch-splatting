# Generated by Powerlevel10k configuration wizard on 2019-12-18 at 13:31 CST.
# Based on romkatv/powerlevel10k/config/p10k-pure.zsh, checksum 53025.
# Wizard options: powerline, pure, instant_prompt=quiet.
...
() {
  ...
  typeset -g POWERLEVEL9K_CONTEXT_ROOT_TEMPLATE='%7F%n%f%242F@CURLY_SLAM_DOCKER'
  # Context format when not root: user@host. The whole thing grey.
  typeset -g POWERLEVEL9K_CONTEXT_TEMPLATE='CURLY_SLAM_DOCKER'
